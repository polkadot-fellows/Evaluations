...
I set up the [parameterization of yearly DOT emission](https://github.com/polkadot-fellows/runtimes/pull/732), giving the people a voice in their own economic parameters. However, it was soon superseded by the hard pressure model above.
