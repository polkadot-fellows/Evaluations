...
### Fixes from whitebox fuzzing reports ([#12689](https://github.com/paritytech/polkadot-sdk/pull/12689), [#12688](https://github.com/paritytech/polkadot-sdk/pull/12688), needs review)
...
### `pallet-asset-rewards` on the Asset Hubs ([runtimes#1222](https://github.com/polkadot-fellows/runtimes/pull/1222), needs review)
